...
export default function Contact() {
  ...
  const handleChange = (e) => {
    ...
    setFormData((p) => ({ ...p, [name]: value }));//jo value change ho rhi h whi update hogi
  ...
  return (
    <section id="contact" className="relative w-full min-h-screen bg-black text-white overflow-hidden  px-6 py-20 md:px-6  flex flex-col
    md:flex-row items-center gap-10">
      ...
      <div className="relative w-full  flex flex-col md:flex-row items-center gap-10">
        ...
        >
          <motion.img src={Astra} alt="Astra image"
        ...
        >
          ...
          <form className="flex flex-col gap-5" onSubmit={handleSubmit}>
            ...
            <div className="flex flex-col">
              <label className="mb-1">Service<span className="text-red-500">*</span></label>
              <select name="service"
